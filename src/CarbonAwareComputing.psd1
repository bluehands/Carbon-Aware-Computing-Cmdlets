#
# Module manifest for module 'CarbonAwareComputing.Cmdlets'
...
GUID = '49A4B8F6-8009-4484-8090-6AE932565511'
...
# Modules to import as nested modules of the module specified in RootModule/ModuleToProcess
 # NestedModules = @('./CarbonAwareComputing.Cmdlets.dll')
...
PrivateData = @{
    ...
    PSData = @{
        ...
        # Tags applied to this module. These help with module discovery in online galleries.
         Tags = @('PSEdition_Core','Windows','Linux','MacOS','CarbonAwareComputing', 'CarbonIntensity')

        # A URL to the license for this module.
        LicenseUri = 'https://github.com/bluehands/Carbon-Aware-Computing-Cmdlets/blob/main/LICENSE'

        # A URL to the main website for this project.
        ProjectUri = 'https://github.com/bluehands/Carbon-Aware-Computing-Cmdlets'
